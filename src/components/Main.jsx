  ...
  return (
    <div id='main'>
        ...
        <div className='absolute md:top-20 top-10 z-[1]'>
          <h2 className='PermanentMarkerFont md:ml-60 ml-10 md:text-7xl text-6xl text-black'>Chayse</h2>
          <h2 className='PermanentMarkerFont md:ml-80 ml-20 md:text-7xl text-5xl text-black'>McMillan</h2>
